"""
Django settings for sfu project.
...
SECRET_KEY = 'django-insecure-1frk891d)tyd*n@+ec5#_yvcrg96w8^q4h4)ux-sz0_e&x-r*t'
...
WSGI_APPLICATION = 'sfu.wsgi.application'
